...
const title=t('Water Potability Index')
  ...
  const onPredictClickHandler = () => {
    ...
    const phValue = predictionValues.ph;

  // Check if pH value is within the range (6 to 8)
    const isPotable = phValue >= 6 && phValue <= 8 ? 1 : 0;
